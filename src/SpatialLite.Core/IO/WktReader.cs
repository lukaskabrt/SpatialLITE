...
namespace SpatialLite.Core.IO {
    ...
    public class WktReader : IDisposable {
        ...
        private static Polygon ParsePolygonText(WktTokensBuffer tokens, bool is3D, bool isMeasured) {
            ...
            Polygon result = new Polygon(linestrings.First().Coordinates, linestrings.Skip(1).Select(ls => ls.Coordinates).ToList());
        ...
        /// <summary>
        /// Parses a geometry collection tagged text.
        /// </summary>
        /// <param name="tokens">The list of tokens.</param>
        ...
        private static GeometryCollection<Geometry> ParseGeometryCollectionText(WktTokensBuffer tokens, bool is3D, bool isMeasured) {
            ...
            geometries.Add(WktReader.ParseGeometryTaggedText(tokens));
            ...
            GeometryCollection<Geometry> result = new GeometryCollection<Geometry>(geometries);
