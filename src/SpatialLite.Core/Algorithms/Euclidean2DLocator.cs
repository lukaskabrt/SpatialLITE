...
public class Euclidean2DLocator : IGeometryLocator
{
    ...
    public bool IsOnLine(Coordinate c, ICoordinateSequence line)
    {
    ...
    public bool IsInRing(Coordinate c, ICoordinateSequence ring)
    {
        if (ring.Count < 3)
        {
    ...
    /// <returns>true if polylines intersects, otherwise false</returns>
    public bool Intersects(ICoordinateSequence line1, ICoordinateSequence line2)
    {
