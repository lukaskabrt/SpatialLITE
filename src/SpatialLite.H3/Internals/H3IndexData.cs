...
{
    /// <summary>
    /// Face centers coordinates in x/y/z on the unit sphere for each of the 20 faces of the icosahedron.
    /// </summary>
    internal static readonly Vec3d[] FaceCenterPoint =
    [
        new(0.2199307791404606, 0.6583691780274996, 0.7198475378926182),
        new(-0.2139234834501421, 0.1478171829550703, 0.9656017935214205),
        new(0.1092625278784797, -0.4811951572873210, 0.8697775121287253),
        new(0.7428567301586791, -0.3593941678278028, 0.5648005936517033),
        new(0.8112534709140969, 0.3448953237639384, 0.4721387736413930),
        new(-0.1055498149613921, 0.9794457296411413, 0.1718874610009365),
        new(-0.8075407579970092, 0.1533552485898818, 0.5695261994882688),
        new(-0.2846148069787907, -0.8644080972654206, 0.4144792552473539),
        new(0.7405621473854482, -0.6673299564565524, -0.0789837646326737),
        new(0.8512303986474293, 0.4722343788582681, -0.2289137388687808),
        new(-0.7405621473854481, 0.6673299564565524, 0.0789837646326737),
        new(-0.8512303986474292, -0.4722343788582682, 0.2289137388687808),
        new(0.1055498149613919, -0.9794457296411413, -0.1718874610009365),
        new(0.8075407579970092, -0.1533552485898819, -0.5695261994882688),
        new(0.2846148069787908, 0.8644080972654204, -0.4144792552473539),
        new(-0.7428567301586791, 0.3593941678278027, -0.5648005936517033),
        new(-0.8112534709140971, -0.3448953237639382, -0.4721387736413930),
        new(-0.2199307791404607, -0.6583691780274996, -0.7198475378926182),
        new(0.2139234834501420, -0.1478171829550704, -0.9656017935214205),
        new(-0.1092625278784796, 0.4811951572873210, -0.8697775121287253)
    ];

    /// <summary>
    /// Face center geo coordinates (lat/lng in radians) for each of the 20 faces of the icosahedron.
    /// </summary>
    ...
    /// </summary>
    internal static readonly double[,] FaceAxesAzimuthsRadsCII =
    {
    ...
    /// <summary>
    /// <para> Given the face number and a resolution 0 ijk+ coordinate in that face's face-centered ijk coordinate
    /// system, gives the base cell located at that coordinate and the number of 60 ccw rotations to rotate into that
    /// base cell's orientation. </para> <para> Valid lookup coordinates are from (0, 0, 0) to (2, 2, 2). </para>
    /// </summary>
