...
public class PbfReaderTests
{
    ...
    {
        string filename = Path.Combine("..", "..", "..", "Data", "Pbf", "pbf-without-osm-header.pbf");
    ...
    {
        string filename = Path.Combine("..", "..", "..", "Data", "Pbf", "pbf-unsupported-required-feature.pbf");
        Assert.Throws<InvalidDataException>(() => new PbfReader(filename, new OsmReaderSettings() { ReadMetadata = false }));
    }
    ...
    {
        string filename = Path.Combine("..", "..", "..", "Data", "Pbf", "pbf-n-node.pbf");
        OsmReaderSettings settings = new();
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-node.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        //read only entity
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-nd-node.pbf"), new OsmReaderSettings() { ReadMetadata = false });
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-nd-node-tags.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        NodeInfo readNode = target.Read() as NodeInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-nd-node-all-properties.pbf"), new OsmReaderSettings() { ReadMetadata = true });
        NodeInfo readNode = target.Read() as NodeInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-nd-node-all-properties.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        NodeInfo readNode = target.Read() as NodeInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-node-tags.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        NodeInfo readNode = target.Read() as NodeInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-node-all-properties.pbf"), new OsmReaderSettings() { ReadMetadata = true });
        NodeInfo readNode = target.Read() as NodeInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-node-all-properties.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        NodeInfo readNode = target.Read() as NodeInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-way.pbf"), new OsmReaderSettings() { ReadMetadata = false });
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-way-tags.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        WayInfo readWay = target.Read() as WayInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-way-all-properties.pbf"), new OsmReaderSettings() { ReadMetadata = true });
        WayInfo readWay = target.Read() as WayInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-way-all-properties.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        WayInfo readWay = target.Read() as WayInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-way-without-nodes.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        WayInfo readWay = target.Read() as WayInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-relation-node.pbf"), new OsmReaderSettings() { ReadMetadata = false });
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-relation-way.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        RelationInfo readRelation = target.Read() as RelationInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-relation-relation.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        RelationInfo readRelation = target.Read() as RelationInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-relation-tags.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        RelationInfo readRelation = target.Read() as RelationInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-relation-all-properties.pbf"), new OsmReaderSettings() { ReadMetadata = true });
        RelationInfo readRelation = target.Read() as RelationInfo;
    ...
    {
        PbfReader target = new(TestDataReader.OpenPbf("pbf-n-relation-all-properties.pbf"), new OsmReaderSettings() { ReadMetadata = false });
        RelationInfo readRelation = target.Read() as RelationInfo;
