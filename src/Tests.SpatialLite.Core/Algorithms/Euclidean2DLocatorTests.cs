...
public class Euclidean2DLocatorTests
{
    ...
    {
        Coordinate a = new(-10, 0);
        Coordinate b = new(3, 2);
        Euclidean2DLocator target = new();
    ...
    {
        Coordinate c = new(0, 0);
        CoordinateList ring = new(new Coordinate[] { new(0, 1), new(1, 0) });
        Euclidean2DLocator target = new();
    ...
    {
        Coordinate c = new(0, 0);
        CoordinateList ring = new(new Coordinate[] { new(0, 1), new(1, 0), new(1, 2) });
        Euclidean2DLocator target = new();
    ...
    {
        Coordinate A1 = new(1.0, 1.0);
        Coordinate B1 = new(2.0, 2.0);

        Coordinate A2 = new(2.0, 1.0);
        Coordinate B2 = new(3.0, 2.0);
    ...
    {
        Coordinate A1 = new(1.0, 1.0);
        Coordinate B1 = new(2.0, 1.0);

        Coordinate A2 = new(2.0, 0.0);
        Coordinate B2 = new(3.0, 1.0);
    ...
    {
        Coordinate A1 = new(1.0, 1.0);
        Coordinate B1 = new(3.0, 1.0);

        Coordinate A2 = new(1.0, 0.0);
        Coordinate B2 = new(3.0, 2.0);
    ...
    {
        ICoordinateList line1 = new CoordinateList(new Coordinate[] { new(1.0, 1.0), new(2.0, 1.0), new(2.0, 2.0) });
        ICoordinateList line2 = new CoordinateList(new Coordinate[] { new(1.0, 0.0), new(2.0, 0.0), new(2.0, -1.0) });
    ...
    {
        ICoordinateList line1 = new CoordinateList(new Coordinate[] { new(1.0, 1.0), new(2.0, 1.0), new(2.0, 2.0) });
        ICoordinateList line2 = new CoordinateList(new Coordinate[] { new(1.0, 0.0), new(1.5, 2.0), new(2.0, -1.0) });
